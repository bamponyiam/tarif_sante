...
$content = file_get_contents("template/template_quote_global_fr_arawan.html");
...
$indication = "<ul>";
$content = str_replace("%option_title%", 'Options pricipales', $content);


if(sizeof($all_1) > 0){
	
	$module_1 = "<h3 style='text-align:center;'>Nos meilleures offres 2017</h3>";
...
if(sizeof($all_1) > 0){
	...
	$module_1 .= "<h5 style='text-align:center;'>Module 1: Hospitalsations uniquement (IN PATIENT)</h5>";
