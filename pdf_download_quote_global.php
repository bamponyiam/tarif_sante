...
if(sizeof($all_1) > 0){
	...
	if($app[0]['date_of_birth'] != ""){
		...
		if( $age_cy != $age_ca){
			$module_1 .= '<td width="15%">Age '.$age_ca.' - '.$age_cy.' ans</td>%age%';
		}else{
			$module_1 .= '<td width="15%">Age '.$app[0]['age'].' ans</td>%age%';
		}
	...
	$module_1 .= '<tr>';
	$module_1 .= '<td width="15%">Assistance / Rapatriement.</td>%assistance%';
	$module_1 .= '</tr>';
